...
document.getElementById("versionSelect").innerHTML += "<option value='2'>DX 3.0.1 </option>";
document.getElementById("versionSelect").innerHTML += "<option value='3'>DX 3.0.2 (Latest)</option>";
